        ...
        <span class="custom-tree-node">
          ...
          <span>
            <el-dropdown @command="handleCommand">
              <a v-if="node.data.isFolder" class="icon-add" >✎</a>
              <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item :command="{type:'file', data:data}">📄 File</el-dropdown-item>
                <el-dropdown-item :command="{type:'folder', data:data} ">📂 Folder</el-dropdown-item>
                <el-dropdown-item :command="{type:'remove', data:data, node:node}">❌ Remove</el-dropdown-item>
              </el-dropdown-menu>
              </template>
            </el-dropdown>
