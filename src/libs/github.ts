...
export async function gitPull(loclRepo:string='') {
  ...
  export async function githubPush(){
    // 本地仓库目录
    const repoDir = '/Users/fusong/note/demo';
    // GitHub 仓库名称
    const repoName = 'demo';
    // GitHub 用户名
    const username = 'zlpx96';
    // GitHub 访问令牌
    const token = 'a326fb8a8e8ca61f39404dba5001d70071a99b3c';
 ...
 export async function getGitFileUsingGithub() {
  ...
  const fileContent = await repo.getContents('c3cef9498405bb88827121298ade91d56b5f2e7c', 'README.md');
